...
public class AccountManagerTest {
    ...
    void testGetActiveAccount() {
        ...
        this.acm.addAccount(jake);
        assertNull(this.acm.getActiveAccount());
        this.acm.setActiveAccount("Eric");
        assertNotNull(this.acm.getActiveAccount());
        assertEquals(this.acm.getActiveAccount(), eric);
    }
    ...
    void testSetActiveAccountName() {
        ...
        assertNotNull(this.acm.getActiveAccount());
        assertEquals(this.acm.getActiveAccount().getName(), "Jake");

        assertTrue(this.acm.setActiveAccountName("Sam"));
        assertEquals(this.acm.getActiveAccount().getName(), "Sam");
    }
